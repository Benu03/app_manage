                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-9 text-md-right" >
                            <a href="{{ route('mobile-management.create') }}" class="btn btn-sm btn-xs btn-xl custom-btn text-primary primary-btn p-1">
                                <p style="font-size: 14px; font-weight: 600; display: flex; align-items: center;">
                                    <img src="{{ asset('img/logo/add_circle.png') }}" alt="" style="margin-right: 2px;margin-left: 3px;">
                    ...
                    <div class="">
                        <table class="table table-sm table-striped" style="width: 100%;" id="tblApp">
                        </table>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#tblApp').DataTable({
                ...
                ajax: {
                    type: "GET",
                    url: "{{ route('mobile-management.get_data') }}",
                },
                columns: [
                    {
                        title: 'NO',
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            let baseUrl = "{{ asset('img/mobile-app') }}";
                    ...
                    },
                    {
                        ...
                        className: 'text-center',
                        render: function(data, type, row) {
                            let editUrl = `{{ url('app-management-mobile/edit') }}/${data}`;
                ...
                initComplete: function(settings, json) {
                    $("#tblApp").wrap("<div style='overflow:auto; width:100%;position:relative;'></div>");
                }

            });

            $('#tblApp_filter input').unbind().bind('keyup', function(e) {
                if (e.keyCode == 13) {

    ...
    <div class="col-md-12">
        <div class="card shadow-none">
            <div class="card-body">
                ...
                <form action="{{ route('mobile-management.store') }}" method="POST" enctype="multipart/form-data" id="formApp">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="app" name="app" style="text-transform: uppercase;">
                                    ...
                                    <div class="row">
                                        <div class="pl-2 mr-4">
                                            <input type="radio" value="active" name="status"
                                                id="status_active" name="status" checked>
                                        ...
                                        <div>
                                            <input type="radio" value="not_active" name="status"
                                                id="status_not_active" name="status">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-10 col-xs-10 col-sm-10">
                                                <div class="form-group">
                                                    ...
                                                    <select name="module" class="form-control select2" id="module" style="width: 100%;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table id="tableModule" class="table table-sm table-bordered" width="100%">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center" style="width: 5%;text-align: center;">No</th>
                                                            <th style="width: 80%;text-align: left;">Module</th>
                                                            <th style="width: 15%;text-align: center !important;">Delete</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    </tbody>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-12">
                                        <textarea name="url_android" id="url_android" cols="5" rows="2" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                            ...
                            <div class="card-footer bg-white">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-12">
                                        <textarea name="url_app_store" id="url_app_store" cols="5" rows="2" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
...
<script src="{{ asset('js/create-app.js') }}" defer></script>
<script>

    $(document).ready(function() {
        // $('div.dataTables_filter input').addClass('col-sm-4 col-md-6 col-xs-4');
    });
    ...
    const submitProses = () => {
        ...
        if (isValid) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('mobile-management.store') }}",
                data: formData,
                processData: false,
                contentType: false,

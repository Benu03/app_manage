...
<!-- Font Awesome -->
<link rel="stylesheet" href="{{ asset('plugins/jqclock/jqClock.css') }}">
...
<!-- Datetimepicker -->
<link rel="stylesheet" href="{{ asset('plugins/datetimepicker/css/tempus-dominus.min.css') }}">
<!-- summernote -->
...
<!-- custom style -->
<link rel="stylesheet" href="{{ asset('dist/css/custom/main.css') }}">
<!-- Google Icons -->
